...
enum class UiTextKey {
    ...
    PTT, CALL, SWITCH_TO_CALL_MODE, SWITCH_TO_PTT_MODE, CALL_MODE_VOICE, LIVE_PTT_TRANSCRIPTION, LAST_TRANSMISSION,
    ...
    UI_LANGUAGE, INCOMING_VOICE_PLAYBACK, INCOMING_VOICE_PLAYBACK_DESC, ONE_BY_ONE, ONE_BY_ONE_DESC,
    OVERLAPPING_VOICES, OVERLAPPING_DESC, OVERLAPPING_NOTE,
...
class UiStrings private constructor(
    ...
    private val english = mapOf(
        ...
        UiTextKey.SWITCH_TO_CALL_MODE to "SWITCH TO CALL MODE",
        UiTextKey.SWITCH_TO_PTT_MODE to "SWITCH TO PTT MODE",
        ...
        UiTextKey.INCOMING_VOICE_PLAYBACK_DESC to "Voices from the same device are always played one by one. This setting controls how voices from different devices are handled when they arrive close together.",
        ...
        UiTextKey.OVERLAPPING_NOTE to "Overlapping allows voices from different devices to play together; each device's own messages remain sequential.",
    ...
    private val hindi = mapOf(
        ...
        UiTextKey.SWITCH_TO_CALL_MODE to "कॉल मोड पर जाएँ",
        UiTextKey.SWITCH_TO_PTT_MODE to "PTT मोड पर जाएँ",
        ...
        UiTextKey.INCOMING_VOICE_PLAYBACK_DESC to "एक ही डिवाइस की आवाज़ें हमेशा एक-एक करके चलती हैं। यह सेटिंग तय करती है कि अलग-अलग डिवाइस की आवाज़ें पास-पास आने पर कैसे चलाई जाएँगी।",
        ...
        UiTextKey.OVERLAPPING_NOTE to "ओवरलैपिंग में अलग-अलग डिवाइस की आवाज़ें एक साथ चल सकती हैं; एक ही डिवाइस के संदेश क्रम से चलते रहेंगे।",
