#!/usr/bin/env python3
"""Run the official English MMS ONNX model with the official VITS tokenizer."""
...
TEXT = "Hello. This is a test of English speech synthesis on the device."
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Path to the official ONNX quantized model.",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("build/tts/mms-tts-eng-official-quantized.wav"),
    )
